...
module  mult_8k01
	...
	assign
		wire_sft10a_in = {w252w, {w252w, {w252w, {w252w, {w252w, {w_lone_sum_node11w[11], {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w252w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft8a_in = {w252w, {w_sum_node10w[59], {w_sum_node10w[58], {w_lone_sum_node11w[13], {w_lone_sum_node11w[12], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w252w, {w252w, {w252w, {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[17:0]},
		datab_node = {dataa[8:0]},
		final_result_node = {w433w[26:0]},
		result = {final_result_node[26:0]},
		w252w = 1'b0,
		w433w = {wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[8]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[8:0]},
		w_lone_sum_node11w = {w_decoder_node9w[161:144]},
		w_sum_node10w = {wire_sum_adder1aa_3result[18:0], w_decoder_node9w[108], wire_sum_adder1aa_2result[18:0], w_decoder_node9w[72], wire_sum_adder1aa_1result[18:0], w_decoder_node9w[36], wire_sum_adder1aa_0result[18:0], w_decoder_node9w[0]};
endmodule //mult_8k01
//VALID FILE
